...
class T5Embedder:
    ...
    def __init__(self, device, dir_or_name='t5-v1_1-xxl', *, cache_dir=None, hf_token=None, use_text_preprocessing=True,
        ...
        self.cache_dir = cache_dir or os.path.expanduser('/root/autodl-tmp/.cache/IF_')
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/.cache/IF_/t5-v1_1-xxl/models--DeepFloyd--t5-v1_1-xxl/snapshots/c9c625d2ec93667ec579ede125fd3811d1f81d37")
        self.model = T5EncoderModel.from_pretrained("/root/autodl-tmp/.cache/IF_/t5-v1_1-xxl/models--DeepFloyd--t5-v1_1-xxl/snapshots/c9c625d2ec93667ec579ede125fd3811d1f81d37", **t5_model_kwargs).eval()
